...
2. Проверить HA в условиях отсутствия Load Balancer'а тем способом, который описан в тексте ТЗ, никак нельзя -- RR при multi-A DNS (если обойтись без изощренных способов вроде Single A Master Name и его захвата, что потребует знать, кто сейчас главный в кворуме), так или иначе, будет иногда указывать  на мертвую ноду. А если и взять этот способ  -- будут накладываться особенности DNS, так что скорость изменения может быть проблемой в любом случае.
